...
import fr.ipst.webcand.v2.webcand.mapper.IActionRechercheMapper;
import fr.ipst.webcand.v2.webcand.services.ActionRechercheService;
...
public class ActionRechercheController {
    ...
    @Autowired
    private ActionRechercheService arservice;
